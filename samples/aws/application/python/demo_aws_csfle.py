...
def configure_data_keys(aws_configuration):
    ...
    client_encryption = ClientEncryption(aws_configuration["kms_providers"],configuration.key_vault_namespace,MongoClient(configuration.connection_uri),CodecOptions())
